        ...
        try {
            ...
            if (body.time == 'Minutes') {
                const dataListExercises = await exercisesPlans.create({
                    ...
                    long: body.long,
                    time: body.time,
                    calAmount: Math.round(
                        (cekExercise.dataValues.calorie / 60) * body.long
                    ),
                    alert: body.alert,
                    date: body.date,
                });
                    ...
                    await exercisesPlans.update(
                        {
                            ...
                            time: req.body.time,
                            calAmount:
                                dataExercise.dataValues.calorie * req.body.long,
                            alert: req.body.alert,
                        },
                    ...
                    await exercisesPlans.update(
                        {
                            ...
                            time: req.body.time,
                            calAmount: Math.round(
                                (dataExercise.dataValues.calorie / 60) *
                                    req.body.long
                            ),
                            alert: req.body.alert,
                        },
            ...
            await calorieTrackers.update(
                {
                    calConsumed:
                        ...
                        cekListExercises.dataValues.calAmount,
                    remainCalSize:
