        ...
        try {
            ...
            if (cekMealsPlan.dataValues.status == 1) {
                return res.status(400).json({
                    status: 'fail',
                    message:
                        'Cant add list meals when status has done or passed',
                });
            }
            ...
            await mealsPlans.update(
                {
                    totalCalAmount:
                        cekMealsPlan.dataValues.totalCalAmount +
                        dataListMeals.dataValues.calAmount,
                },
            ...
            await mealsPlans.update(
                {
                    totalCalAmount:
                        cekMealsPlan.dataValues.totalCalAmount -
                        cekListMeals.dataValues.calAmount,
                },
